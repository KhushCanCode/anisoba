...
function Footer(){
    return(
        <>
        <footer className=" bg-gradient-to-t  from-green-800  to-slate-950 ">
        <div className="mx-auto w-full max-w-screen-xl">
                <p className="text-green-500 text-sm pl-4 pt-8">Questions? Call 1-844-505-2993</p>
            <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                <div>
                    <h2 className="mb-6 text-sm font-semibold uppercase text-white">FAQ</h2>
                    <ul className="text-gray-300 font-medium">
                        <li className="mb-4">
                            <a href="#" className=" hover:underline">Investors Relation</a>
                        </li>
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold uppercase text-white">Media Center</h2>
            ...
            <div className="px-4 py-6 md:flex md:items-center md:justify-between">
                ...
                <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                    <a href="#" className="text-slate-800 hover:text-white ">
